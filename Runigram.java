...
public class Runigram {
	...
	public static void main(String[] args) {
		...
		*/
		...
		// Tests the grayscale of an image:
	...
	public static Color[][] read(String fileName) {
		...
		while (!in.isEmpty()) {  //it's not necessary because we presume that the input is ok and we run accordingly to the numbers of rows and columns. but just in case..
	...
	public static Color[][] flippedHorizontally(Color[][] image) {
		...
		for(int i = 0; i < image.length; i++)
		{
			...
			{
				newImage[i][colsIndex] = image[i][j];
				colsIndex++;
			}
			colsIndex = 0;
		}
	...
	public static Color[][] scaled(Color[][] image, int width, int height) {
		Color[][] newScaledimage = new Color [height][width];
		int h0 = image.length;
		...
		for(int i = 0; i < height; i++)
		{
			...
			{
				newScaledimage[i][j] = image[i * h0 / height][j * w0 / width];
			}
		}
